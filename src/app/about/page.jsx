              ...
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                  ...
                  <p className="mb-2 text-gray-600">
                    ...
                    expanding infrastructure, the department is dedicated to
                    preserving the integrity and functionality of the
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div className="relative h-full ml-0 mr-0 sm:mr-10">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-blue-400 rounded-lg">
                  <div className="flex items-center -mt-1">
                    <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                      Facilities Booking and Permissions:
                    </h3>
                  </div>
                ...
                <div className="relative h-full p-5 bg-white border-2 border-yellow-400 rounded-lg">
                  ...
                  <p className="mb-2 text-gray-600">
                    ...
                    <p>
                      ...
                      Collaboration is at the heart of the departments
                      operations, working closely with other departments,
                      faculty, staff, and students to achieve common goals and
            ...
            <div className="w-full sm:w-1/2">
              <div className="relative h-full ml-0 md:mr-10">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-green-500 rounded-lg">
                  ...
                  <p className="mb-2 text-gray-600">
                    <p>
                      <span className="font-bold">Innovation:</span> Embracing
                      innovation and best practices in estate management, the
                      department continuously seeks opportunities to improve
                      processes, optimize resources, and adapt to evolving needs
                      and challenges.
                    </p>
                    <p>
                      <span className="font-bold">Sustainability:</span> With a
                      focus on sustainability, the department strives to
                      implement environmentally friendly practices in the
                      maintenance and development of college infrastructure,
                      contributing to a greener and more eco-conscious campus.
                    </p>
                  </p>
                </div>
              </div>
